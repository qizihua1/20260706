        ...
        <div className="flex items-center gap-1">
          ...
          {row.id === "__new__" ? (
            <button
              ...
              title="取消新增（不保存，丢弃填写）"
              className="px-2.5 py-1.5 rounded-md border border-gray-200 text-gray-500 hover:bg-gray-50 hover:text-gray-700 hover:border-gray-400 text-xs font-medium"
            >
              取消
            </button>
          ) : (
...
export default function ApprovalThresholdsPage() {
  ...
  const newRow: ThresholdRow = useMemo(
    () => ({ ...DEFAULT_ROW, id: "__new__" }),
    []
  );
        ...
        actions={
          <>
            ...
            <button
              ...
              title="新增一条审批阈值（编辑完成后点保存，或点取消关闭）"
            >
